    ...
    if ($conditionSetting3) {
      if ($userCommission['status'] == $conditionSetting3) {
        ...
        if (is_array($paymentMethod) && count($paymentMethod) > 0) {
          $temp['woo_rotation_lucky_name'] = $paymentMethod['name'];
          $temp['woo_rotation_lucky_stk'] = $paymentMethod['stk'];
          $temp['woo_rotation_lucky_bankname'] = $paymentMethod['bankname'];
        } else {
          $temp['woo_rotation_lucky_name'] = '';
          $temp['woo_rotation_lucky_stk'] = '';
          $temp['woo_rotation_lucky_bankname'] = '';
        }
  ...
  <tbody>
    ...
    ?>
      <tr>
        ...
        <td><?php echo $userCommissionStatus4['woo_rotation_lucky_name'] ?></td>
        <td><?php echo $userCommissionStatus4['woo_rotation_lucky_stk'] ?></td>
        <td><?php echo $userCommissionStatus4['woo_rotation_lucky_bankname'] ?></td>
